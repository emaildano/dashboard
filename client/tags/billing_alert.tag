<billingAlert>
    <div class="panel-body">
        <p hide="{opts.account.cardLast4Digits}">Regist your credit card first.</p>
        <div class="col-lg-12" show="{opts.account.cardLast4Digits}">
                    ...
                    <div id="collapseTwo" class="panel-collapse collapse in">
                        <div class="panel-body">
                            <form role="form" id="payment-form">
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input id="alert_price" type="text" class="form-control" name="Number" placeholder="100" value="{billingalert.billingAlertPrice}" required />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-xs-12">
                                        <button id="btnRegistBillingAlert" class="ladda-button ladda-button-demo btn btn-primary" data-style="expand-right" type="submit" onclick="{ regist_alert }">Register Cost Alert</button>
                                    </div>
                                </div>
                            </form>
                        </div>

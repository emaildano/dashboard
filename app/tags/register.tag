      ...
      <div>
            ...
            <form class="m-t" role="form" action="login.html">
                <div class="form-group">
                    <input id="user_id" type="text" class="form-control" placeholder="Username" required="">
                </div>
                <div class="form-group">
                ...
                <!--<div class="form-group">
                        <div class="checkbox i-checks"><label> <input type="checkbox"><i></i> I agree to <a href="#">Shifter terms</a>.</label></div>
                </div>-->
                <button id="register" type="button" class="ladda-button ladda-button-demo btn btn-primary block full-width m-b" onclick="{ signup }" data-style="expand-right">Register Now</button>

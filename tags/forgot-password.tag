        ...
        <div class="row">
            <div class="col-md-12">
                <div class="ibox-content">
                    <p>
                        To create new password, enter your username or email and we&apos;ll send you a password reset link.
                    </p>
                    <div class="row">
                      <div class="col-lg-12">
                        <form class="m-t" role="form" action="/">
                          <div class="form-group">
                            <input type="text" class="form-control" placeholder="Username or Email" required="" name="user_id">
                          </div>
                          <button id="reminder" type="button" class="ladda-button ladda-button-demo btn btn-primary block full-width m-b" onclick="{ reminder }" data-style="expand-right">Get A New Password!</button>
                        </form>
                      </div>
                    </div>
                </div>

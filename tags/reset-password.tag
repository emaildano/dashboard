                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form class="m-t" role="form" action="/">
                                ...
                                <button id="resetpassword" type="button" class="ladda-button ladda-button-demo btn btn-primary block full-width m-b" data-style="expand-right" onclick="{ resetpassword }">Reset Password</button>
                            </form>
                        </div>
                    </div>
                </div>
